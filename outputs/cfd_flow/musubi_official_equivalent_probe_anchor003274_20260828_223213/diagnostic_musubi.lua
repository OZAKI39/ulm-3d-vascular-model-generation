...
tracking = {
  {
    ...
    shape = { kind = 'all' },
    reduction = { 'average' },
    time_control = { min = { iter = 167464 }, max = { iter = maximum_iterations }, interval = { iter = 100 } },
    output = { format = 'ascii' }
  },
  {
    label = 'u',
...
restart = {
  read = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_convergence_probe_anchor003274_20260828_210236/restart/roi003274_steady_lbm_lastHeader.lua',
  write = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_official_equivalent_probe_anchor003274_20260828_223213/restart/'
}
