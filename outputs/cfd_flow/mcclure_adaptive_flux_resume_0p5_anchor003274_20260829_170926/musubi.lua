-- Isolated adaptive-flux continuation; restart from iteration 154326.
...
sim_control = {
  ...
  abort_criteria = {
    ...
    convergence = {
      ...
      time_control = { min = { iter = 154326 }, max = { iter = maximum_iterations }, interval = { iter = 100 } },
      norm = 'average',
      nvals = 50,
      absolute = true,
      condition = {
        { threshold = 0.729525879482435, operator = '<=' },
        { threshold = 4.919279003768086e-07, operator = '<=' }
      }
    }
  }
}
...
restart = {
  read = 'restart/a3274_lastHeader.lua',
  write = 'restart/',
  time_control = {
    min = { iter = 174326 },
