...
timing_file = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_convergence_probe_anchor003274_20260828_201535/tracking/diagnostic_timing.res'
...
sim_control = {
  time_control = {
    max = { iter = maximum_iterations, clock = 300 },
    interval = { iter = 100 }
  },
  abort_criteria = {
    stop_file = 'stop',
...
tracking = {
  {
    ...
    folder = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_convergence_probe_anchor003274_20260828_201535/tracking/',
    variable = { 'pressure_phy' },
    shape = { kind = 'all' },
    reduction = { 'average' },
    time_control = { min = { iter = 162464 }, max = { iter = maximum_iterations }, interval = { iter = 100 } },
    output = { format = 'ascii' }
  },
  {
...
restart = {
  ...
  write = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_convergence_probe_anchor003274_20260828_201535/tracking/diagnostic_restart/'
}
