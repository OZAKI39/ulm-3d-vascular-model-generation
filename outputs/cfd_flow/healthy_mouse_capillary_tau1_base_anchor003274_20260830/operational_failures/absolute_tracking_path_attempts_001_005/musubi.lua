...
timing_file = '/home/lzy/u3da/tau1_base_20260830/segments/segment_0239502/tracking/timing.res'
...
sim_control = {
  time_control={max={iter=maximum_iterations, clock=7200}, interval={iter=1198}},
  abort_criteria={stop_file='/home/lzy/u3da/tau1_base_20260830/stop'}
}
tracking = {
  {label='p', folder='/home/lzy/u3da/tau1_base_20260830/segments/segment_0239502/tracking/p/', variable={'pressure_phy'},
    shape={kind='all'}, reduction={'average'},
    time_control={min={iter=0}, max={iter=maximum_iterations}, interval={iter=59875}},
    output={format='ascii'}},
  {label='u', folder='/home/lzy/u3da/tau1_base_20260830/segments/segment_0239502/tracking/u/', variable={'vel_mag_phy'},
    shape={kind='all'}, reduction={'average'},
    time_control={min={iter=0}, max={iter=maximum_iterations}, interval={iter=59875}},
    output={format='ascii'}}
}
restart = {write='/home/lzy/u3da/tau1_base_20260830/restart/',
