...
timing_file = '/tmp/u3d/timing.res'
...
sim_control = {
  ...
  abort_criteria = {
    ...
    convergence = {
      ...
      time_control = { min = { iter = 173464 }, max = { iter = maximum_iterations }, interval = { iter = 100 } },
      norm = 'average',
      nvals = 100,
      absolute = true,
      condition = {
...
restart = {
  read = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_official_equivalent_probe_anchor003274_20260828_223213/restart/roi003274_steady_lbm_lastHeader.lua',
  write = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/musubi_project_steady_confirmation_anchor003274_20260828_225334/restart/'
}
