-- Isolated healthy fast steady continuation; Python exact gates are final.
simulation_name = 'a3274'
...
tracking = {
  {
    ...
    time_control = { min = { iter = 314166 }, max = { iter = maximum_iterations }, interval = { iter = 5000 } },
    output = { format = 'ascii' }
  },
  {
...
restart = {
  read = 'restart/a3274_lastHeader.lua', write = 'restart/',
  time_control = { min = { iter = 319166 }, max = { iter = maximum_iterations }, interval = { iter = 5000 } }
}
