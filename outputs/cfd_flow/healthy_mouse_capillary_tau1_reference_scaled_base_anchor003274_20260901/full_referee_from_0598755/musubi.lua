...
sim_control = {
  ...
  abort_criteria={stop_file='/home/lzy/u3da/tau1_reference_scaled_base_20260901/full_referee_from_0598755/stop'}
}
restart = {read='/home/lzy/u3da/tau1_reference_scaled_base_20260901/restart/tau1_reference_scaled_base_header_598755.lua', write='/home/lzy/u3da/tau1_reference_scaled_base_20260901/full_referee_from_0598755/restart/',
  timeformat={use_iter=true},
  time_control={min={iter=598756}, max={iter=maximum_iterations},
    interval={iter=1}}
}
