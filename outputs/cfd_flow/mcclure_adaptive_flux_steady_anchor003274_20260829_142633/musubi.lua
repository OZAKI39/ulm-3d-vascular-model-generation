-- Isolated adaptive-flux steady baseline; fresh initialization.
simulation_name = 'roi003274_adaptive_flux_steady'
...
sim_control = {
  ...
  abort_criteria = {
    ...
    convergence = {
      ...
      absolute = true,
      condition = {
        { threshold = 0.14590517589648699, operator = '<=' },
        { threshold = 9.8385580075361729e-08, operator = '<=' }
      }
    }
  }
}
...
tracking = {
  {
    label = 'p', folder = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/mcclure_adaptive_flux_steady_anchor003274_20260829_142633/tracking/p/',
  ...
  {
    label = 'u', folder = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/mcclure_adaptive_flux_steady_anchor003274_20260829_142633/tracking/u/',
...
restart = { write = '/mnt/e/ULM/hatimb-particle_flow_simulator/ulm_3D_vascular/outputs/cfd_flow/mcclure_adaptive_flux_steady_anchor003274_20260829_142633/restart/' }
