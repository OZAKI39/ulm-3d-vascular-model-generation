-- Fresh/resumable repaired Tau1 fine grid member.
...
sim_control = {
  ...
  abort_criteria={stop_file='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine/stop'}
}
restart = {write='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine/restart/', timeformat={use_iter=true},
  time_control={min={iter=5000}, max={iter=maximum_iterations},
    interval={iter=5000}}
}
