...
folder = 'mesh/'
comment = 'repaired Tau1 coarse grid; physical objects frozen from Base'
debug = { debugMode = false, debugFiles = false, debugMesh = 'debug/' }
minlevel = 9
bounding_cube = { origin = { 7.8082771579034594e-05, 5.4076359424537688e-05, 8.8206398940868488e-05 }, length = 0.00013312 }
spatial_object = {
  {
  ...
  },
  {
    ...
    geometry = { kind = 'canoND', object = { origin = { 0.0001016827715790346, 5.5476359424537688e-05, 0.00015880639894086848 }, vec = { { 3.9999999999999888e-06, 0, 0 }, { 0, 4.2000000000000004e-06, 0 } } } }
  },
  {
