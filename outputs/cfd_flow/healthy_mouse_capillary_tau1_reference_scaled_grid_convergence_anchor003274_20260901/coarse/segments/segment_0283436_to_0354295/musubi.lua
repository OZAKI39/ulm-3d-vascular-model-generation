...
restart = {read='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/coarse/restart/tau1_reference_scaled_coarse_header_283436.lua', write='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/coarse/restart/', timeformat={use_iter=true},
  time_control={min={iter=354295}, max={iter=maximum_iterations},
    interval={iter=70859}}
}
