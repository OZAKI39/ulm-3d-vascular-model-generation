-- One-call, one-timestep pre-fix population diagnostic from preserved Fine 5000.
simulation_name = 'tau1_reference_scaled_fine_pref_fix_forensic'
...
sim_control = {
  ...
  abort_criteria={stop_file='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_pref_fix_forensic/stop'}
}
restart = {read='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine/restart/tau1_reference_scaled_fine_header_5000.lua',
  write='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_pref_fix_forensic/restart/',
  timeformat={use_iter=true},
  time_control={min={iter=5001}, max={iter=maximum_iterations}, interval={iter=1}}
}
