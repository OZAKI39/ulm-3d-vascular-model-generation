-- Single-call fresh-init post-fix target oracle; maximum one timestep.
simulation_name = 'tau1_reference_scaled_fine_postfix_oracle'
...
sim_control = {
  ...
  abort_criteria={stop_file='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_postfix_oracle/stop'}
}
restart = {write='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_postfix_oracle/restart/',
  timeformat={use_iter=true},
  time_control={min={iter=1}, max={iter=maximum_iterations}, interval={iter=1}}
}
