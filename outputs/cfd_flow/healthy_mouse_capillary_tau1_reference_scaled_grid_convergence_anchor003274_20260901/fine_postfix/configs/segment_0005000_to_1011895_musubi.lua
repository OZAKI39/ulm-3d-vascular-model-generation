-- Continuation of the same repaired Fine logical simulation after safety PASS.
...
sim_control = {
  time_control={max={iter=maximum_iterations}, interval={iter=202379}},
  abort_criteria={stop_file='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_postfix/stop'}
}
restart = {read='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_postfix/restart/tau1_reference_scaled_fine_postfix_header_5000.lua',
  write='/home/lzy/u3da/tau1_reference_scaled_cbf_20260901/fine_postfix/restart/',
  timeformat={use_iter=true},
  time_control={min={iter=202379}, max={iter=maximum_iterations}, interval={iter=202379}}
}
