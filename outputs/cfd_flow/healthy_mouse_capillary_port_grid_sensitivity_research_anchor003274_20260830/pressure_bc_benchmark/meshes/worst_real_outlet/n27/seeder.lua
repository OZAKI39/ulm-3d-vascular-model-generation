...
folder = 'mesh/'
comment = 'fixed physical Hagen-Poiseuille pipe, N=27'
debug = { debugMode = false, debugFiles = false, debugMesh = 'debug/' }
minlevel = 8
bounding_cube = { origin = { -1.4958834517714462e-05, -1.4958834517714462e-05, -1.4958834517714462e-05 }, length = 2.9917669035428923e-05 }
spatial_object = {
