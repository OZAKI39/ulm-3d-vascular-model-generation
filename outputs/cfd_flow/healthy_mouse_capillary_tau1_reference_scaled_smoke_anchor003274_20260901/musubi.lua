...
tracking = {
  {label='state_000000', folder='tracking/state_000000/', variable={'density_phy','velocity_phy'}, shape={kind='all'}, time_control={min={iter=0}, max={iter=0}, interval={iter=1}}, output={format='ascii'}},
  {label='state_000001', folder='tracking/state_000001/', variable={'density_phy','velocity_phy'}, shape={kind='all'}, time_control={min={iter=1}, max={iter=1}, interval={iter=1}}, output={format='ascii'}},
  {label='state_000010', folder='tracking/state_000010/', variable={'density_phy','velocity_phy'}, shape={kind='all'}, time_control={min={iter=10}, max={iter=10}, interval={iter=1}}, output={format='ascii'}},
  {label='state_000100', folder='tracking/state_000100/', variable={'density_phy','velocity_phy'}, shape={kind='all'}, time_control={min={iter=100}, max={iter=100}, interval={iter=1}}, output={format='ascii'}},
  {label='state_001000', folder='tracking/state_001000/', variable={'density_phy','velocity_phy'}, shape={kind='all'}, time_control={min={iter=1000}, max={iter=1000}, interval={iter=1}}, output={format='ascii'}},
  {label='state_005000', folder='tracking/state_005000/', variable={'density_phy','velocity_phy'}, shape={kind='all'}, time_control={min={iter=5000}, max={iter=5000}, interval={iter=1}}, output={format='ascii'}}
}
