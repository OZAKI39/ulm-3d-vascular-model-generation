...
def run_official_vmtk(
    *,
    ...
    request: dict[str, Any] = {
        ...
        "centerlines_vtp": str(paths.centerlines_vtp.resolve()),
...
def exchange_paths(
    *, input_directory: Path, vmtk_directory: Path, geometry_directory: Path
    ...
    return VmtkExchangePaths(
        ...
        raw_vtp=geometry_directory / "vmtk_flowextension_raw_um.vtp",
        raw_stl=geometry_directory / "vmtk_flowextension_raw_um.stl",
        remeshed_open_vtp=vmtk_directory / "vmtk_flowextension_remeshed_open_um.vtp",
        capped_vtp=vmtk_directory / "vmtk_flowextension_remeshed_capped_um.vtp",
        request_json=vmtk_directory / "request.json",
        result_json=vmtk_directory / "environment.json",
